...
ckpt_path='/mnt/qb/baumgartner/cschmidt77_data/exp4_acdc_train_DT_budget304'  
...
for lr in 0.05
   do
   for budget in 304 #10% from 3040
      do
      $exec_command python3 -u $code_path/run.py --exp-name "2021-10-26-acdc_train_stdAug_ImageNetBackbone_budget_${budget}_lr_${lr}_seed_${SLURM_ARRAY_TASK_ID}" \
      ...
      --patience 30 --region-size 64 64 --epoch-num 1000 \
      --rl-episodes 100 --rl-buffer 600 --lr-dqn 0.001 --dqn-epochs 20 \
