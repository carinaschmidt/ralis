...
#SBATCH --array=20,77  # random seeds: 20,55,77,123,234 
...
for lr_rate in 0.01 # std aug, DT=3
   do
   $exec_command python3 $code_path/train_supervised.py --exp-name "2021-11-05-supervised-brats18_DT3_stdAug_ImageNetBackbone_lr_${lr_rate}_${SLURM_ARRAY_TASK_ID}" --checkpointer \
