...
#SBATCH --time=00-01:00            # Runtime in D-HH:MM
...
for al_algorithm in 'ralis'
   ...
   for budget in 35584 
       ...
       --exp-name-toload-rl "2021-10-31-brats18_ImageNetBackbone_stdAug_budget_1536_lr_0.01_seed_55" \
       --budget-labels $budget --num-each-iter 64 --al-algorithm $al_algorithm --rl-pool 100 --train --final-test
       done
   done
