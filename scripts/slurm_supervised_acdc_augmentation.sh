...
for lr_rate in 0.01
    do
    $exec_command python3 $code_path/train_supervised.py --exp-name "2021-08-04-check-Augmentations" --checkpointer \
    --ckpt-path $ckpt_path --data-path $data_path \
    --input-size 128 128 --dataset 'acdc' \
    --epoch-num 10 --lr $lr_rate --train-batch-size 32 --val-batch-size 8 --patience 10 \
    --seed 123 \
