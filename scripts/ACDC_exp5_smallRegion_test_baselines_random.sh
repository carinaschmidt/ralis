...
for al_algorithm in 'random'
   ...
   for budget in 16 32 64 128 592 960 1184 1424 1904 2384 3568
       do
       $exec_command python3 -u $code_path/run.py --exp-name "2021-11-03-acdc_ImageNetBackbone_baseline_${al_algorithm}_3232_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" \
