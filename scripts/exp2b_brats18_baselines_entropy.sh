...
#SBATCH -o logs/exp2bald_%A_%a.out      # Standard output
#SBATCH -e logs/exp2bald_%A_%a.err      # Standard error
...
for al_algorithm in 'entropy'
   ...
   for budget in 35584 #64 384 1792 3584 17792 
       ...
       --budget-labels $budget --num-each-iter 64 --al-algorithm $al_algorithm --rl-pool 100 --train --test --final-test
       done
   done