...
for budget in 64 384 1792 3584 17792 #60*16=960 regions, 192 is 20%
    do                                                                                                                                   
    $exec_command python3 -u $code_path/evaluate_patients_brats18.py --exp-name "2021-11-04-brats18_ImageNetBackbone_baseline_entropy_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" --checkpointer \
...
for budget in 64 384 1792 3584 17792  #60*16=960 regions, 192 is 20%
    do                                                                              
    $exec_command python3 -u $code_path/calculate3Ddice_patientwise_brats18.py --exp-name "2021-11-04-brats18_ImageNetBackbone_baseline_entropy_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" --checkpointer \
...
for budget in 35584  #60*16=960 regions, 192 is 20%
    do                                                                                                                                   
    $exec_command python3 -u $code_path/evaluate_patients_brats18.py --exp-name "2021-11-06-brats18_ImageNetBackbone_baseline_entropy_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" --checkpointer \
    --ckpt-path $ckpt_path --data-path $data_path \
    --dataset 'brats18' --al-algorithm 'ralis'
    done
...
for budget in 35584   #60*16=960 regions, 192 is 20%
    do                                                                              
    $exec_command python3 -u $code_path/calculate3Ddice_patientwise_brats18.py --exp-name "2021-11-06-brats18_ImageNetBackbone_baseline_entropy_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" --checkpointer \
    --ckpt-path '/mnt/qb/baumgartner/cschmidt77_data/_FINAL_brats18_exp6/' --data-path $data_path \
    --dataset 'brats18' --al-algorithm 'ralis'
    done
