...
for lr in 0.01 0.05
   ...
   for budget in 608 #20% from 3040
      do
      $exec_command python3 -u $code_path/run.py --full-res --exp-name "2021-10-08-acdc_train_RIRD_ImageNetBackbone_budget_${budget}_lr_${lr}_seed_${SLURM_ARRAY_TASK_ID}" \
