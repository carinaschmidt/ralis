...
for al_algorithm in 'ralis'
   do
   for budget in 16 32 64 128 592 960 1184 1424 1904 2384 3568 # 47616
       do
       $exec_command python3 -u $code_path/run.py --exp-name "2021-11-19-acdc_ImageNetBackbone_baseline_${al_algorithm}_3232_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" \
       ...
       --exp-name-toload-rl "2021-11-19-acdc_3232_train_2patients_ImageNetBackbone_budget_512_lr_0.05_seed_${SLURM_ARRAY_TASK_ID}" \
