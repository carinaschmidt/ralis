...
code_path='/home/baumgartner/cschmidt77/devel/ralis_notPretrained'
...
for lr_rate in 0.001 0.01 0.05
    do
    $exec_command python3 $code_path/train_supervised.py --exp-name '2021-07-18-supervised_msdHeart'$lr_rate --checkpointer \
    --ckpt-path $ckpt_path --data-path $data_path \
    --input-size 256 256 --dataset 'msdHeart' \
    --epoch-num 1000 --lr $lr_rate --train-batch-size 32 --val-batch-size 8 --patience 30 \
