...
for lr in 0.01
    do
    for budget in 32 64 128 960
        do
        $exec_command python3 -u $code_path/run.py --exp-name "2021-08-02-test_acdc_ImageNetBackbone_budget_${budget}_lr_${lr}_dt" \
        ...
        --exp-name-toload-rl "2021-08-02-train_acdc_ImageNetBackbone_budget_608_lr_${lr}" \
