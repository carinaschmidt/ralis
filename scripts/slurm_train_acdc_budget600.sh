...
#SBATCH --array=123,234  # random seeds: 20,77,123,234
...
for lr in 0.001 0.01 0.05
    ...
    for budget in 608
        do
        $exec_command python3 -u $code_path/run.py --exp-name "2021-07-17-train_acdc_ImageNetBackbone_budget_${budget}_lr_${lr}_seed_${SLURM_ARRAY_TASK_ID}" \
