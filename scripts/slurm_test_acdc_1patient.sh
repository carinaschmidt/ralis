...
### ACDC 1 patient = 19 slices, 304 regions, 64 are 21% labelled### 

for lr in 0.01
    do
    for budget in 16 32 64 128 960
        do
        $exec_command python3 -u $code_path/run.py --exp-name "2021-08-02-test_acdc_ImageNetBackbone_lr_${lr}_32_1patient_budget_${budget}" \
        ...
        --exp-name-toload-rl "2021-08-05-train_acdc_ImageNetBackbone_budget_32_lr_${lr}_1patient" \
