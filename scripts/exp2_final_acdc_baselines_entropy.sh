...
#SBATCH -o logs/exp2_entropy_%A_%a.out      # Standard output
#SBATCH -e logs/exp2_entropy_%A_%a.err      # Standard error
...
for al_algorithm in 'entropy'
   ...
   for budget in 64 128 592 960 1184 1424 1904 2384 3568
       do
       $exec_command python3 -u $code_path/run.py --exp-name "2021-11-03-acdc_ImageNetBackbone_baseline_${al_algorithm}_budget_${budget}_seed_${SLURM_ARRAY_TASK_ID}" \
       ...
       --patience 50 --region-size 64 64 --epoch-num 49 \
