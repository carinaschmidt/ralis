...
for al_algorithm in 'random'
    ...
    for budget in 1920 3840 7680 11520 19200 30720
        ...
        for seed in 20 50 234 4560 12
            do
            $exec_command python3 $code_path/run.py --exp-name 'baseline_cityscapes_'$al_algorithm'_budget_'$budget'_seed'$seed --seed $seed  --checkpointer \
...
for al_algorithm in 'random'
    ...
    for budget in 480 720 960 1200 1440 1920
        ...
        for seed in 20 50 234 4560 12
            do
            $exec_command python3 $code_path/run.py --exp-name 'baseline_camvid_'$al_algorithm'_budget_'$budget'_seed'$seed --seed $seed  --checkpointer \
            --ckpt-path $ckpt_path --data-path $data_path \
