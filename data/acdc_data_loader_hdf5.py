...
if __name__ == '__main__':
    #input_folder = '/mnt/qb/baumgartner/rawdata/ACDC_challenge'
    input_folder = '/mnt/qb/baumgartner/cschmidt77_data/acdc_challenge/train'
    preprocessing_folder = '/home/baumgartner/cschmidt77/devel/ralis/acdc/preproc_data/train'

    #carina: added mode '2D'
    #carina: added target resolution (1.36719, 1.36719) (same as size)
    d = load_and_maybe_process_data(input_folder, preprocessing_folder, '2D', (256, 256), (1.36719, 1.36719),
